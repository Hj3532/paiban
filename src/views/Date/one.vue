  ...
  <el-card style="background-color: #F6FAFD; border-radius: 20px;margin-top: 10px">
    ...
    <div>
      <div class="button">
        <el-button
          v-if="daochu"
          style="color: #00a4ff; font-size: 14px; border-radius: 20px;width: 120px;"
          @click="port"
        >导出</el-button>
        <el-button
          v-if="!daochu"
        ...
        <el-button
          ...
          @click="change1"
        >交换</el-button>
        <el-button v-if="btn" icon="el-icon-search" style="border-radius: 20px" @click="exchange">切换视图</el-button>
